      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Pathlight represents a fundamental shift in assistive technology. 
            Instead of relying on visual cues, we're building a world where spatial awareness 
            and audio guidance empower blind individuals to navigate independently with confidence.
          </p>
        </motion.div>
      </div>
    </section>
