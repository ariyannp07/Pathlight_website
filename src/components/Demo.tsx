      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            See how Pathlight transforms navigation from a visual challenge into an intuitive, 
            eyes-closed experience.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-300">Traditional Navigation</h3>
            </div>
            ...
            <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center mb-6">
              <div className="text-center">
                ...
                <p className="text-gray-400">Visual dependency required</p>
              </div>
            </div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center">
                ...
                Requires constant visual attention
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-red-500 rounded-full mr-3" />
              ...
              <li className="flex items-center">
                <div className="w-2 h-2 bg-red-500 rounded-full mr-3" />
                Can't multitask while navigating
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-xl font-semibold text-white">Pathlight Navigation</h3>
            </div>
            ...
            <div className="aspect-video bg-gradient-to-br from-blue-800/50 to-purple-800/50 rounded-xl flex items-center justify-center mb-6 relative overflow-hidden">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-blue-200">Eyes closed navigation</p>
              </div>
            </div>
